...
object DotEnvConfig {
    ...
    val jwtIssuer: String get() = DotEnv.get("JWT_ISSUER", "pecado")
    val jwtAudience: String get() = DotEnv.get("JWT_AUDIENCE", "back-signus")
    val jwtRealm: String get() = DotEnv.get("JWT_REALM", "back-signus")
